...
function BookModal() {
    ...
    const title = 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';
            ...
            <div className="modal-overlay">
                <div className="modal">
                    ...
                    <div className="modal-content">
                        <span className="modal-book-title">{title}</span>
                        <span className="modal-book-author">{author}</span>
                        ...
                        <div className="modal-icon-text-container">
                            ...
                            <span className="modal-text">Publish date: {date}</span>
                        </div>
                        <div className="modal-icon-text-container">
                            ...
                            <span className="modal-text">{rating} (OpenLibrary)</span>
                        </div>
                        <div className="modal-icon-text-container">
